...
/// convert optional inbound utf8 buffer to string
...
/// catch and unwinde error with i32 return
...
/// Obtain directory key for SAFEDrive - This can be cached for efficiency.
...
/// Traverse directory tree to get the final subdirectory.
